...
void allPossibleSubset(int arr[],int n)
{
	...
	{
		// The inner for loop will run n times , As the maximum number
		//of elements a set can have is n
		// This loop will generate a subset
		for (int j = 0; j < n; j++)
		{
			// This if condition will check if jth bit in binary
			// representation of  i  is set or not
			// if the value of (i & (1 << j)) is greater than 0 ,
